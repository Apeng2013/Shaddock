...
#include <filesystem>
	...
	#define SD_INTERNAL_ASSERT_NO_MSG(type, check) SD_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", SD_STRINGIFY_MACRO(check), std::filesystem::path(__FILE__).filename(), __LINE__)
